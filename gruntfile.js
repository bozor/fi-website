module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            ...
            fonts: { cwd: 'src/fonts/', dest: 'public_html/fonts', expand: true, src: '**' },
    ...
    grunt.registerTask('prod', ['clean:all', 'stylesheets:prod', 'js:prod', 'assemble', 'targethtml:prod', 'newer:imagemin:all', 'copy:xml', 'copy:php', 'copy:twitter', 'copy:htaccess', 'copy:fonts', 'hashres', 'lineremover:prod']);
